        ...
        <>
            ...
            <div className="relative max-w-3xl glide-08 mx-auto overflow-x-hidden">
                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                                                <p>
                                                    This  is probably one of the best services I've
                ...
                >
                    ...
                    >
                        <span className="block w-2 h-2 transition-colors duration-300 rounded-full bg-neutral/20 opacity-70 ring-1 ring-slate-700 focus:outline-none"></span>
                    </button>
                    <button
                        className="p-4 group"
                        data-glide-dir="=1"
