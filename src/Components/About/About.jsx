        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="md:flex justify-between items-center gap-4">
                <div className="w-full md:w-1/2">
                    <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-primary uppercase rounded-full bg-teal-accent-400">About</p>
                    <h1 className="text-4xl text-white font-bold  uppercase">Welcome!... <br />Proof of Quality Is On the Autohunt </h1>
                </div>
                <div className="w-full md:w-1/2">
